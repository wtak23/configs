...
; --- GENERAL CONFIGURATION ----------------------------------------------------
  ...
  MinSpeed      := 2      ; Pixels to move at the beginning of the movement
  ...
  MouseSleep    := 1     ; MSeconds to sleep between moving the mouse (<- this impacts the cursor speed) (smaller the faster)
