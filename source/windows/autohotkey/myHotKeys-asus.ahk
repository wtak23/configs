...
;--------------------------------------------------------------------------
; Win+Alt+m
#!m::RunOrActivate("C:\Program Files\MATLAB\R2011b\bin\matlab.exe")
; Win+alt+shift+m
#!+m::RunOrActivate("control /name Microsoft.Mouse")
...
if GetKeyState("Shift","P")
    ...
    RunOrActivate("C:\Program Files\MATLAB\R2011b\bin\matlab.exe")
...
CapsLock & +::
    if GetKeyState("Shift","P")
        ...
        Send ^{End}
    return
CapsLock & m::RunOrActivate("C:\Program Files\MATLAB\R2011b\bin\matlab.exe")
...
XButton1 & Mbutton::SendInput ^{LButton} ; new window
XButton2 & MButton::Send ^{F5} ; refresh window
Lbutton & Rbutton::SendInput ^{w} ; close window
...
;   http://www.autohotkey.com/board/topic/77982-how-to-map-multiple-keys-into-one-key/
...
XButton1 & m::RunOrActivate("C:\Program Files\MATLAB\R2011b\bin\matlab.exe")
...
; XButton1 & a::RunOrActivate("C:\Anaconda\pythonw.exe")
