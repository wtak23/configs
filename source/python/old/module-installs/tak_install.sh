...
# yes | pip install ipywidgets # <- seems to screw up things
...
#=============================================================#
# notebook extensions (this also seem to screw things up....)
...
# to unscrew things https://github.com/spyder-ide/spyder/issues/2608
