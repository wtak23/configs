...
Feb 24, 2016
############
Updating keras via pip messed up my spyder config (gets the "kernel died unexpectedly")...so did a reinstall of spyder as follows:
...
.. rubric:: Getting junk to work on the server 04-03-2016 (22:48)
...
########################################
moduel-install: VERY old modules install
########################################
.. note:: 

    ``moduel-install``  --- contains my own module installer scripts when I first started using Python.

    So yeah, I was a rookie then, so take whatever I did with a huge grain of salt.

****************************************
``./module-installs/install_modules.sh``
****************************************
.. literalinclude:: ./module-installs/install_modules.sh
    :language: bash
    :linenos:

****************************************
``./module-installs/pyinstall.sh``
****************************************
.. literalinclude:: ./module-installs/pyinstall.sh
    :language: bash
    :linenos:

****************************************
``./module-installs/spams_install.sh``
****************************************
.. literalinclude:: ./module-installs/spams_install.sh
    :language: bash
    :linenos:

****************************************
``./module-installs/tak_install.sh``
****************************************
.. literalinclude:: ./module-installs/tak_install.sh
    :language: bash
    :linenos:
